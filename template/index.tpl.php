...
<div id="dreambox">
    <div class="section indexScroll" id="index">
        <div class="bg">
            <img src="/build/dist/img/logo.png" width="100%" class="logo">
            <div class="kvArea">
                <div class="kvCon">
                    <div class="kvitem kv1"></div>
                    <div class="kvitem kv2"></div>
                    <div class="kvitem kv3"></div>
                </div>
                <img src="/build/dist/img/kv1.jpg" width="100%" class="opacity0">
            </div>
            <div class="activeDesc">
                感恩母亲节，除了送上贴心问候之余<br>
                也不要忘了用相机记录下妳们之间的温馨时刻
            </div>
            
            <div class="enterArea">
                <a href="/kol/index.html" class="btn">达人时尚大片</a>
                <a href="/offstore/index.html" class="btn">刻字服务体验</a>
                <a href="application/index.html" class="btn">记录温馨时刻</a>
...
<div class="popup-rule transition hidden" id="rule-pop">
  <div class="p-model">
    <h4>活动细则 <i class="ruleclose"><img src="" sourcesrc="/build/dist/img/close.png" width="100%"></i></h4>
...
<script type="text/javascript">
    var allimg = [
       ...
       '/build/dist/img/kv1.jpg',
       '/build/dist/img/kv2.jpg',
       '/build/dist/img/kv3.jpg',
    ];
    ...
    pfun.loadingFnDoing(allimg, function(){
        ...
        pfun.overscroll(document.querySelector("#pop-rule")); 
